...
if ($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $_SESSION['post-yaratildi']="Post muvofaqiyatli yaratildi";
                    ...
                    <div class="p-5 mb-4 bg-body-tertiary rounded-3">
                        <form method="POST" action="" class="container-fluid py-5">
                                <div class="mb-3">
                                    ...
                                    <input  name="title" type="text" class="form-control" id="exampleFormControlInput1" placeholder="sarlavha">
                                </div>
                                <div class="mb-3">
                                    <label  class="form-label">Ma'lumot</label>
                                    <textarea name="body" class="form-control"  rows="3" placeholder="Ma'lumot"></textarea>
                                </div>
